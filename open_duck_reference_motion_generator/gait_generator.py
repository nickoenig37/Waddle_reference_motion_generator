...
episode["Placo"] = {
    ...
    "period": pwe.period,
    "left_target": list(pwe.parameters.box_overlap_clip(placo.HumanoidRobot_Side.left, np.array([args.dx, args.dy, args.dtheta]))),
    "right_target": list(pwe.parameters.box_overlap_clip(placo.HumanoidRobot_Side.right, np.array([args.dx, args.dy, args.dtheta]))),
}
